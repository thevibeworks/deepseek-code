// HTTP handlers for routes. Thin: parse, delegate, serialize.
...
const { validateRoute } = require("../lib/validators");
...
function makeHandlers(repo) {
  return {
    ...
    async put(req, res) {
      ...
      res.json(toWire(repo.put(route)));
    },
