// Wire serialization for routes. The external representation is
...
function toWire(route) {
  const out = {};
  for (const [internal, wire] of Object.entries(WIRE_KEYS)) {
    if (route[internal] !== undefined) out[wire] = route[internal];
  }
  return out;
}
